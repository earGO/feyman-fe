...
const FooterSocial = () =>{
    return (
            <div className="pv4 ph3 ph5-ns tc">
                <a className="link near-black hover-silver dib h2 w2 mr3" href="https://www.facebook.com/fedor.logvinov" title="Facebook">
                ...
                <a className="link near-black hover-silver dib h2 w2 mr3"
                   href="https://github.com/earGO" title="GitHub">
                ...
                {/*
                <a className="link hover-silver near-black dib h2 w2 mr3" href="#" title="Stack Overflow">
                ...
                <a className="link hover-silver near-black dib h2 w2 mr3" href="https://www.linkedin.com/in/fedor-logvinov-b6186738/" title="LinkedIn">
